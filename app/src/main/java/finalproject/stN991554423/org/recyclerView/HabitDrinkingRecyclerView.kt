...
class HabitDrinkingRecyclerView  (private val sampleList: List<HabitDrinking>): RecyclerView.Adapter <HabitDrinkingRecyclerView.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.field1.text= currentItem.drinkingDate
        holder.field2.text= currentItem.drinkingFrequency.toString()
        holder.field3.text= currentItem.drinkingConsumption.toString()
