...
class FirestoreViewModel : ViewModel() {
    ...
    fun getAllHabitRun(): MutableList<HabitRun>? {
        firebaseRepository.getRunCollection()
    ...
    fun getAllHabitDrinking(): MutableList<HabitDrinking>? {
        firebaseRepository.getDrinkingCollection()
            .addSnapshotListener(EventListener<QuerySnapshot> { value, e ->
                if (e != null) {
                    Log.w(TAG, "Listen failed.", e)
    ...
    fun getAllHabitSleep(): MutableList<HabitSleep>? {
        firebaseRepository.getSleepCollection()
            .addSnapshotListener(EventListener<QuerySnapshot> { value, e ->
                if (e != null) {
                    Log.w(TAG, "Listen failed.", e)
    ...
    fun getAllHabitMeditation(): MutableList<HabitMeditation>? {
        firebaseRepository.getMeditationCollection()
            .addSnapshotListener(EventListener<QuerySnapshot> { value, e ->
                if (e != null) {
                    Log.w(TAG, "Listen failed.", e)
    ...
    fun getAllHabitYoga(): MutableList<HabitYoga>? {
        firebaseRepository.getYogaCollection()
            .addSnapshotListener(EventListener<QuerySnapshot> { value, e ->
                if (e != null) {
                    Log.w(TAG, "Listen failed.", e)
    ...
    fun getAllHabitReading(): MutableList<HabitReading>? {
        firebaseRepository.getReadingCollection()
            .addSnapshotListener(EventListener<QuerySnapshot> { value, e ->
                if (e != null) {
                    Log.w(TAG, "Listen failed.", e)
